...
class ReportHtmlTests(unittest.TestCase):
    def test_sections_and_n(self) -> None:
        ...
        self.assertIn("83 of 84 attempts", html)
        self.assertIn("15 of 18 pairs matched exactly", html)
        self.assertIn(
            "one patient diagnosis query and both pairs from one clinician-phrased query",
            html,
        )
        self.assertIn("academic sources were 33.3%", html)
        self.assertIn("0 of 210 on patient-phrased", html)
        self.assertIn("12 times across all positions", html)
        self.assertIn("29.5% of patient top-three citations", html)
        self.assertIn("none of the 36 clinician top-three citations", html)
        self.assertIn("ran the other way", html)
        self.assertIn("falling as low as 0.067 Jaccard", html)
        self.assertNotIn("were the reverse", html)
        self.assertNotIn("0.07 Jaccard", html)
        self.assertIn("98 citations", html)
        self.assertIn("17 of those 98 appear in the top three", html)
        self.assertIn("cited 19 times", html)
        self.assertIn("boehringer-ingelheim.com appeared in six of seven runs", html)
